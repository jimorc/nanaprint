...
namespace nanaprint
{
    ...
    void PrintDialogSettings::set_media_size(const std::optional<MediaSize>& mediaSize)
    {
    ...
    void PrintDialogSettings::set_color_mode(const ColorMode colorMode)
    {
    ...
    void PrintDialogSettings::set_side(const Side side)
    {
        m_side = side;
    }
}
