...
int main()
{
    ...
    for(auto printer : pPrinters)
    {
        ...
        cout << "    ";
        cout << ((defaultMediaSource) ? defaultMediaSource.value().get_source() : "None") << "\n";
        ...
        cout << "    ";
        cout << ((defaultMediaType) ? defaultMediaType.value().get_type() : "None") << "\n";
        ...
        cout << "    ";
        cout << ((defaultColorMode) ? defaultColorMode.value().getColorMode() : "None") << "\n";
